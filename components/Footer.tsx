      ...
      >
        <Stack direction={["column", "row"]} spacing="20px">
          ...
          <chakra.img
            ...
            alignSelf="center"
          ></chakra.img>
          {/* <chakra.img h="40px" src="/redreamer_logo.png"></chakra.img> */}
        </Stack>
        <chakra.p py={{ base: "2", sm: "0" }} color="white" fontSize="xs">
          2022 宙獅Metalion 版權所有翻印必究
        </chakra.p>
        {/* </BoxtextAlign=> */}
        {/* </Center> */}
        ...
        {/* <Box mx="-2">
          <Stack
            ...
            alignItems="center"
          > */}
        {/* <Box height="30px" w="full"> */}
        {/* <chakra.img
          h="40px"
          src="/mithras-logo.png"
        ></chakra.img>
        <chakra.img
          h="40px"
          src="/gp-logo.png"
